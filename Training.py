...
datos_entrenamiento = 'C:/www/UMG/IA/pythonSingLanguage/Fotos/Entrenamiento'
datos_validacion = 'C:/www/UMG/IA/pythonSingLanguage/Fotos/Validacion'
...
clases = 7  #Cada clase pertenece a una palabra
...
cnn.add(Dense(1792,activation='relu'))  #Asignamos 256 neuronas
