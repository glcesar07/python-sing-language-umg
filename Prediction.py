...
#from keras_preprocessing.image import load_img, img_to_array #Descomentar esta linea y comentar la linea 7 en caso de que no funcione

modelo = 'C:/www/UMG/IA/pythonSingLanguage/Modelo.h5'
peso =  'C:/www/UMG/IA/pythonSingLanguage/pesos.h5'
